              ...
              <div className="flex items-center">
                  ...
                  <Link href="/">
                    <a aria-label="Logo">
                      <svg
                        ...
                        className="h-8 w-8  hover:text-red-300 focus:text-red-300 dark:text-red-300  dark:text-red-300 "
                      >
                ...
                <div className=" hidden md:block">
                  <div className="ml-10 flex items-baseline space-x-4">
                    <Link href="/">
                      <a className=" hover:bg-red-300 focus:bg-red-300 dark:hover:bg-gray-900  dark:focus:bg-gray-900 px-3 py-2 rounded-md text-sm lg:text-base font-medium">
                        Home
                      </a>
                    </Link>
                    <Link href="/projects">
