...
let TemplateTag = function () {
          ...
          _createClass(TemplateTag, [
            ...
            },
            {
              ...
              value: function transformString(str) {
                let cb = function cb(res, transform) {
  ...
  \************************************************************************************* */
      /***/ (
         ...
         */
        let inlineArrayTransformer = function inlineArrayTransformer() {
  let opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaults;
          return {
            onSubstitution: function onSubstitution(substitution, resultSoFar) {
              // only operate on arrays
              if (Array.isArray(substitution)) {
                let arrayLength = substitution.length;
                let {separator} = opts;
                let {conjunction} = opts;
                let {serial} = opts;
                // join each item in the array into a string where each item is separated by separator
                // be sure to maintain indentation
                let indent = resultSoFar.match(/(\n?[^\S\n]+)$/);
                if (indent) {
                ...
                if (conjunction && arrayLength > 1) {
                  let separatorIndex = substitution.lastIndexOf(separator);
                  substitution =
  ...
  \************************************************************************************************************* */
      /***/ (
        ...
        let isValidValue = function isValidValue(x) {
          return x != null && !Number.isNaN(x) && typeof x !== 'boolean';
        };

let removeNonPrintingValuesTransformer = function removeNonPrintingValuesTransformer() {
            return {
  ...
  \***************************************************************************************** */
      /***/ (
         ...
         * @return {Object}                      - a TemplateTag transformer
         */
let replaceResultTransformer = function replaceResultTransformer(replaceWhat, replaceWith) {
          return {
...
let replaceStringTransformer = function replaceStringTransformer(replaceWhat, replaceWith) {
          return {
...
let replaceSubstitutionTransformer = function replaceSubstitutionTransformer(replaceWhat, replaceWith) {
            return {
  ...
  \************************************************************************************* */
      /***/ (
        ...
        let splitStringTransformer = function splitStringTransformer(splitBy) {
          return {
            onSubstitution: function onSubstitution(substitution, resultSoFar) {
  ...
  \************************************************************************************* */
      /***/ (
         ...
         * @return {Object}                  - a TemplateTag transformer
         */
        let stripIndentTransformer = function stripIndentTransformer() {
          var type =
  ...
  \*********************************************************************************** */
      /***/ (
         ...
         * @return {Object}           - a TemplateTag transformer
         */
        let trimResultTransformer = function trimResultTransformer() {
  let side = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
          return {
            onEndResult: function onEndResult(endResult) {
              if (side === '') {
...
let commonTags = __webpack_require__(/*! common-tags */ './node_modules/common-tags/es/index.js');

        let generateHtml = function generateHtml(str) {
          return {
...
let _reactHelmet = __webpack_require__(/*! react-helmet */ './node_modules/react-helmet/es/Helmet.js');

        let onRenderBody = function onRenderBody(_ref) {
          let {setHeadComponents} = _ref;
      var setHtmlAttributes = _ref.setHtmlAttributes;
      var {setBodyAttributes} = _ref;

          let helmet = _reactHelmet.Helmet.renderStatic(); // These action functions were added partway through the Gatsby 1.x cycle.
  ...
  \************************************* */
    ...
    var hashDelete = __webpack_require__(/*! ./_hashDelete */ "./node_modules/lodash/_hashDelete.js");
    var hashGet = __webpack_require__(/*! ./_hashGet */ "./node_modules/lodash/_hashGet.js");
    var hashHas = __webpack_require__(/*! ./_hashHas */ "./node_modules/lodash/_hashHas.js");
    var       hashSet = __webpack_require__(
  ...
  \****************************************** */
    ...
    var listCacheDelete = __webpack_require__(/*! ./_listCacheDelete */ "./node_modules/lodash/_listCacheDelete.js");
    var listCacheGet = __webpack_require__(/*! ./_listCacheGet */ "./node_modules/lodash/_listCacheGet.js");
    var listCacheHas = __webpack_require__(/*! ./_listCacheHas */ "./node_modules/lodash/_listCacheHas.js");
    var listCacheSet = __webpack_require__(/*! ./_listCacheSet */ './node_modules/lodash/_listCacheSet.js');
  ...
  \***************************************** */
    ...
    var mapCacheDelete = __webpack_require__(/*! ./_mapCacheDelete */ "./node_modules/lodash/_mapCacheDelete.js");
    var mapCacheGet = __webpack_require__(/*! ./_mapCacheGet */ "./node_modules/lodash/_mapCacheGet.js");
    var mapCacheHas = __webpack_require__(/*! ./_mapCacheHas */ "./node_modules/lodash/_mapCacheHas.js");
    var mapCacheSet = __webpack_require__(/*! ./_mapCacheSet */ './node_modules/lodash/_mapCacheSet.js');
  ...
  \************************************** */
    ...
    var stackClear = __webpack_require__(/*! ./_stackClear */ "./node_modules/lodash/_stackClear.js");
    var stackDelete = __webpack_require__(/*! ./_stackDelete */ "./node_modules/lodash/_stackDelete.js");
    var stackGet = __webpack_require__(/*! ./_stackGet */ "./node_modules/lodash/_stackGet.js");
    var stackHas = __webpack_require__(/*! ./_stackHas */ "./node_modules/lodash/_stackHas.js");
    var stackSet = __webpack_require__(/*! ./_stackSet */ './node_modules/lodash/_stackSet.js');
  ...
  \********************************************** */
    ...
    var isArguments = __webpack_require__(/*! ./isArguments */ "./node_modules/lodash/isArguments.js");
    var isArray = __webpack_require__(/*! ./isArray */ "./node_modules/lodash/isArray.js");
    var isBuffer = __webpack_require__(/*! ./isBuffer */ "./node_modules/lodash/isBuffer.js");
...
let baseCreate = (function() {
  ...
  \******************************************* */
    ...
    var getRawTag = __webpack_require__(/*! ./_getRawTag */ "./node_modules/lodash/_getRawTag.js");
    var objectToString = __webpack_require__(/*! ./_objectToString */ './node_modules/lodash/_objectToString.js');
  ...
  \********************************************* */
    ...
    var isMasked = __webpack_require__(/*! ./_isMasked */ "./node_modules/lodash/_isMasked.js");
    var isObject = __webpack_require__(/*! ./isObject */ "./node_modules/lodash/isObject.js");
    var toSource = __webpack_require__(/*! ./_toSource */ './node_modules/lodash/_toSource.js');
...
let reIsNative = RegExp(`^${ 
  ...
  \************************************************* */
    ...
    var isLength = __webpack_require__(/*! ./isLength */ "./node_modules/lodash/isLength.js");
    var isObjectLike = __webpack_require__(/*! ./isObjectLike */ './node_modules/lodash/isObjectLike.js');
  ...
  \******************************************* */
    ...
    var       nativeKeysIn = __webpack_require__(
  ...
  \****************************************** */
    ...
    var baseMergeDeep = __webpack_require__(/*! ./_baseMergeDeep */ "./node_modules/lodash/_baseMergeDeep.js");
    var isObject = __webpack_require__(/*! ./isObject */ "./node_modules/lodash/isObject.js");
    var keysIn = __webpack_require__(/*! ./keysIn */ "./node_modules/lodash/keysIn.js");
    var safeGet = __webpack_require__(/*! ./_safeGet */ './node_modules/lodash/_safeGet.js');
  ...
  \********************************************** */
    ...
    var cloneBuffer = __webpack_require__(/*! ./_cloneBuffer */ "./node_modules/lodash/_cloneBuffer.js");
    var cloneTypedArray = __webpack_require__(/*! ./_cloneTypedArray */ "./node_modules/lodash/_cloneTypedArray.js");
    var copyArray = __webpack_require__(/*! ./_copyArray */ "./node_modules/lodash/_copyArray.js");
    var initCloneObject = __webpack_require__(/*! ./_initCloneObject */ "./node_modules/lodash/_initCloneObject.js");
    var isArguments = __webpack_require__(/*! ./isArguments */ "./node_modules/lodash/isArguments.js");
    var isArray = __webpack_require__(/*! ./isArray */ "./node_modules/lodash/isArray.js");
    ...
    var isTypedArray = __webpack_require__(/*! ./isTypedArray */ "./node_modules/lodash/isTypedArray.js");
    var safeGet = __webpack_require__(/*! ./_safeGet */ "./node_modules/lodash/_safeGet.js");
    var toPlainObject = __webpack_require__(/*! ./toPlainObject */ './node_modules/lodash/toPlainObject.js');
  ...
  \***************************************** */
    ...
    var overRest = __webpack_require__(/*! ./_overRest */ "./node_modules/lodash/_overRest.js");
    var       setToString = __webpack_require__(
...
let root = __webpack_require__(/*! ./_root */ './node_modules/lodash/_root.js');

        /** Detect free variable `exports`. */
let freeExports =  true && exports && !exports.nodeType && exports;

        /** Detect free variable `module`. */
let freeModule = freeExports && 'object' === 'object' && module && !module.nodeType && module;
  ...
  \*********************************************** */
    ...
    var isIterateeCall = __webpack_require__(/*! ./_isIterateeCall */ './node_modules/lodash/_isIterateeCall.js');
...
let freeGlobal = typeof global === 'object' && global && global.Object === Object && global;
  ...
  \****************************************** */
    ...
    var getValue = __webpack_require__(/*! ./_getValue */ './node_modules/lodash/_getValue.js');
  ...
  \************************************************ */
    ...
    var getPrototype = __webpack_require__(/*! ./_getPrototype */ "./node_modules/lodash/_getPrototype.js");
    var isPrototype = __webpack_require__(/*! ./_isPrototype */ './node_modules/lodash/_isPrototype.js');
...
let maskSrcKey = (function() {
  ...
  \********************************************** */
    ...
    var Map = __webpack_require__(/*! ./_Map */ './node_modules/lodash/_Map.js');
  ...
  \***************************************** */
      /***/ (module, exports, __webpack_require__) => {
        /* module decorator */ module = __webpack_require__.nmd(module);
let freeGlobal = __webpack_require__(/*! ./_freeGlobal */ './node_modules/lodash/_freeGlobal.js');
...
let freeSelf = typeof self === 'object' && self && self.Object === Object && self;
  ...
  \******************************************** */
    ...
    var shortOut = __webpack_require__(/*! ./_shortOut */ './node_modules/lodash/_shortOut.js');
  ...
  \******************************************* */
    ...
    var       isObjectLike = __webpack_require__(
        ...
        /** Built-in value references. */
        let {propertyIsEnumerable} = objectProto;
...
let isArguments = baseIsArguments(function() { return arguments; }()) ? baseIsArguments : function(value) {
  ...
  \**************************************** */
      /***/ (module, exports, __webpack_require__) => {
        /* module decorator */ module = __webpack_require__.nmd(module);
let root = __webpack_require__(/*! ./_root */ './node_modules/lodash/_root.js');
    var stubFalse = __webpack_require__(/*! ./stubFalse */ './node_modules/lodash/stubFalse.js');
...
let freeModule = freeExports && 'object' === 'object' && module && !module.nodeType && module;
  ...
  \******************************************** */
    ...
    var baseUnary = __webpack_require__(/*! ./_baseUnary */ "./node_modules/lodash/_baseUnary.js");
    var       nodeUtil = __webpack_require__(
...
let isTypedArray = nodeIsTypedArray ? baseUnary(nodeIsTypedArray) : baseIsTypedArray;
  ...
  \************************************** */
    ...
    var baseKeysIn = __webpack_require__(/*! ./_baseKeysIn */ "./node_modules/lodash/_baseKeysIn.js");
    var       isArrayLike = __webpack_require__(
            /*! ./isArrayLike */ './node_modules/lodash/isArrayLike.js'
          );
  ...
  \************************************* */
    ...
    var createAssigner = __webpack_require__(/*! ./_createAssigner */ './node_modules/lodash/_createAssigner.js');
...
let assign = __webpack_require__(/*! object-assign */ './node_modules/object-assign/index.js');

let ReactPropTypesSecret = __webpack_require__(/*! ./lib/ReactPropTypesSecret */ './node_modules/prop-types/lib/ReactPropTypesSecret.js');
let checkPropTypes = __webpack_require__(/*! ./checkPropTypes */ './node_modules/prop-types/checkPropTypes.js');
...
let printWarning = function() {};
    ...
    if (x === y) {
      ...
      let valuesString = JSON.stringify(expectedValues, function replacer(key, value) {
  ...
  \***************************************** */
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        if (true) {
  let ReactIs = __webpack_require__(/*! react-is */ './node_modules/react-is/index.js');
...
let hasArrayBuffer = typeof ArrayBuffer === 'function' && !!ArrayBuffer.isView;
  ...
  \*********************************************** */
      /***/ (
        ...
        let VALID_TAG_NAMES = Object.keys(TAG_NAMES).map(function (name) {
...
let HTML_TAG_MAP = Object.keys(REACT_TAG_MAP).reduce(function (obj, key) {
          obj[REACT_TAG_MAP[key]] = key;
          return obj;
        },
        {});

let SELF_CLOSING_TAGS = [TAG_NAMES.NOSCRIPT, TAG_NAMES.SCRIPT, TAG_NAMES.STYLE];
...
let _extends = Object.assign || function (target) {
        ...
        let encodeSpecialCharacters = function encodeSpecialCharacters(str) {
    let encode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
        ...
        let getTitleFromPropsList = function getTitleFromPropsList(propsList) {
...
let getOnChangeClientState = function getOnChangeClientState(propsList) {
          return (
...
let getAttributesFromPropsList = function getAttributesFromPropsList(tagType, propsList) {
          return propsList
...
let getBaseTagFromPropsList = function getBaseTagFromPropsList(primaryAttributes, propsList) {
          return propsList
            .filter(function (props) {
            ...
            .reduce(function (innermostBaseTag, tag) {
              if (!innermostBaseTag.length) {
                ...
                for (let i = 0; i < keys.length; i++) {
                  let attributeKey = keys[i];
                  let lowerCaseAttributeKey = attributeKey.toLowerCase();
...
let getTagsFromPropsList = function getTagsFromPropsList(tagName, primaryAttributes, propsList) {
          // Calculate list of tags, giving priority innermost component (end of the propslist)
          let approvedSeenTags = {};
          ...
          return propsList
            ...
            .reduce(function (approvedTags, instanceTags) {
              ...
              instanceTags
                .filter(function (tag) {
                  let primaryAttributeKey = void 0;
                  let keys = Object.keys(tag);
                  for (let i = 0; i < keys.length; i++) {
                    let attributeKey = keys[i];
                    let lowerCaseAttributeKey = attributeKey.toLowerCase();
                  ...
                  let value = tag[primaryAttributeKey].toLowerCase();
              ...
              let keys = Object.keys(instanceSeenTags);
              for (let i = 0; i < keys.length; i++) {
                let attributeKey = keys[i];
                var tagUnion =
        ...
        let reducePropsToState = function reducePropsToState(propsList) {
          return {
        ...
        let cafPolyfill = function cafPolyfill(id) {
          return clearTimeout(id);
        };

let requestAnimationFrame = typeof window !== 'undefined' ? window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || rafPolyfill : global.requestAnimationFrame || rafPolyfill;

let cancelAnimationFrame = typeof window !== 'undefined' ? window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || cafPolyfill : global.cancelAnimationFrame || cafPolyfill;
...
let handleClientStateChange = function handleClientStateChange(newState) {
          if (_helmetCallback) {
        ...
        var commitTagChanges = function commitTagChanges(newState, cb) {
          let {baseTag} = newState;
        var bodyAttributes = newState.bodyAttributes;
        ...
        var {titleAttributes} = newState;
          ...
          Object.keys(tagUpdates).forEach(function (tagType) {
            let _tagUpdates$tagType = tagUpdates[tagType];
            var newTags = _tagUpdates$tagType.newTags;
            var {oldTags} = _tagUpdates$tagType;
        ...
        let flattenArray = function flattenArray(possibleArray) {
        ...
        var updateAttributes = function updateAttributes(tagName, attributes) {
          let elementTag = document.getElementsByTagName(tagName)[0];

          if (!elementTag) {
            return;
          }

          let helmetAttributeString = elementTag.getAttribute(HELMET_ATTRIBUTE);
    let helmetAttributes = helmetAttributeString ? helmetAttributeString.split(',') : [];
          let attributesToRemove = [].concat(helmetAttributes);
          let attributeKeys = Object.keys(attributes);

          for (let i = 0; i < attributeKeys.length; i++) {
            let attribute = attributeKeys[i];
        let value = attributes[attribute] || '';
            ...
            let indexToSave = attributesToRemove.indexOf(attribute);
            if (indexToSave !== -1) {
              attributesToRemove.splice(indexToSave, 1);
            }
          }

          for (let _i = attributesToRemove.length - 1; _i >= 0; _i--) {
    ...
    let headElement = document.head || document.querySelector(TAG_NAMES.HEAD);
          var tagNodes = headElement.querySelectorAll(
            type + '[' + HELMET_ATTRIBUTE + ']'
          );
          let oldTags = Array.prototype.slice.call(tagNodes);
          let newTags = [];
          let indexToDelete = void 0;
...
let generateElementAttributesAsString = function generateElementAttributesAsString(attributes) {
            return Object.keys(attributes).reduce(function (str, key) {
        let attr = typeof attributes[key] !== 'undefined' ? `${key  }="${  attributes[key]  }"` : '' + key;
              return str ? str + ' ' + attr : attr;
            }, '');
          };

let generateTitleAsString = function generateTitleAsString(type, title, attributes, encode) {
          let attributeString = generateElementAttributesAsString(attributes);
          let flattenedTitle = flattenArray(title);
...
let generateTagsAsString = function generateTagsAsString(type, tags, encode) {
          return tags.reduce(function (str, tag) {
            ...
            let attr = typeof tag[attribute] === 'undefined' ? attribute : `${attribute  }="${  encodeSpecialCharacters(tag[attribute], encode)  }"`;
                return string ? string + ' ' + attr : attr;
              }, '');

            var tagContent = tag.innerHTML || tag.cssText || '';

            let isSelfClosing = SELF_CLOSING_TAGS.indexOf(type) === -1;
...
let convertElementAttributestoReactProps = function convertElementAttributestoReactProps(attributes) {
...
let convertReactPropstoHtmlAttributes = function convertReactPropstoHtmlAttributes(props) {
...
let generateTitleAsReactComponent = function generateTitleAsReactComponent(type, title, attributes) {
            let _initProps;

            // assigning into an array to define toString function on it
    let initProps = (_initProps = {
                key: title,
              }),
...
let generateTagsAsReactComponent = function generateTagsAsReactComponent(type, tags) {
            return tags.map(function (tag, i) {
              ...
              Object.keys(tag).forEach(function (attribute) {
                let mappedAttribute = REACT_TAG_MAP[attribute] || attribute;

                if (
                  mappedAttribute === TAG_PROPERTIES.INNER_HTML ||
                  mappedAttribute === TAG_PROPERTIES.CSS_TEXT
                ) {
                  let content = tag.innerHTML || tag.cssText;
        ...
        let getMethodsForTag = function getMethodsForTag(type, tags, encode) {
          switch (type) {
        ...
        let mapStateOnServer = function mapStateOnServer(_ref) {
          let {baseTag} = _ref;
        ...
        let Helmet = function Helmet(Component) {
          let _class; var _temp;
              ...
              (function (_React$Component) {
                ...
                HelmetWrapper.prototype.flattenArrayTypeChildren =
                  function flattenArrayTypeChildren(_ref) {
                    ...
                    let {child} = _ref;
                var arrayTypeChildren = _ref.arrayTypeChildren;
                var newChildProps = _ref.newChildProps;
                var {nestedChildren} = _ref;
                ...
                HelmetWrapper.prototype.mapObjectTypeChildren =
                  function mapObjectTypeChildren(_ref2) {
                    let _babelHelpers$extends2; var _babelHelpers$extends3;

                    let {child} = _ref2;
                var newProps = _ref2.newProps;
                var newChildProps = _ref2.newChildProps;
                var {nestedChildren} = _ref2;
                    ...
                    switch (child.type) {
                      ...
                      case TAG_NAMES.BODY:
                        return { ...newProps, bodyAttributes: _extends({}, newChildProps)};

                      case TAG_NAMES.HTML:
                        return { ...newProps, htmlAttributes: _extends({}, newChildProps)};
                    }
                ...
                HelmetWrapper.prototype.mapChildrenToProps =
                  function mapChildrenToProps(children, newProps) {
                    ...
                    var nestedChildren = _child$props.children;
                    var childProps = objectWithoutProperties(_child$props, ['children']);
                ...
                var     props = objectWithoutProperties(_props, ['children']);
        ...
        let NullComponent = function NullComponent() {
          return null;
        };

let HelmetSideEffects = react_side_effect__WEBPACK_IMPORTED_MODULE_1___default()(reducePropsToState, handleClientStateChange, mapStateOnServer)(NullComponent);
...
let REACT_SUSPENSE_LIST_TYPE = hasSymbol ? Symbol.for('react.suspense_list') : 0xead8;
...
let REACT_FUNDAMENTAL_TYPE = hasSymbol ? Symbol.for('react.fundamental') : 0xead5;
let REACT_RESPONDER_TYPE = hasSymbol ? Symbol.for('react.responder') : 0xead6;
...
let React = __webpack_require__(/*! react */ 'react');
...
let canUseDOM = !!(typeof window !== 'undefined' && window.document && window.document.createElement);
        function withSideEffect(
          ...
          return function wrap(WrappedComponent) {
            ...
            var SideEffect = /*#__PURE__*/ (function (_PureComponent) {
              ...
              let _proto = SideEffect.prototype;
    ...
    /***/ 'react-dom/server':
      /*!**********************************************************************************************************************!*\
  !*** external "/home/just-a-random-person-to-ignore/Documents/portfolio-v2_gatsby/node_modules/react-dom/server.js" ***!
  \********************************************************************************************************************* */
      /***/ (module) => {
        'use strict';

        module.exports = require('/home/just-a-random-person-to-ignore/Documents/portfolio-v2_gatsby/node_modules/react-dom/server.js');
    ...
    /***/ react:
      /*!*****************************************************************************************************************!*\
  !*** external "/home/just-a-random-person-to-ignore/Documents/portfolio-v2_gatsby/node_modules/react/index.js" ***!
  \**************************************************************************************************************** */
      /***/ (module) => {
        'use strict';

        module.exports = require('/home/just-a-random-person-to-ignore/Documents/portfolio-v2_gatsby/node_modules/react/index.js');
  ...
  let __webpack_export_target__ = exports;
