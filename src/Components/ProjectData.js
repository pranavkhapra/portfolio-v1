...
const uzumakiStore = {
  title: 'Uzumaki Store',
  description:
    'Uzumaki Store a full stack online clothing store complete with real credit checkout,users can search, sell, add to cart items.The application has six main models — Users, Items, Orders, CartItems, OrderItems, and Roles — all of which are relational and showcase the power of relational GraphQL Queries.The app also includes many server side bits including authentication, permissions, sending email, uploading images, and charging credit cards. i also tried  Testing the React application for the first time.',
  stack: {
    first: 'React',
